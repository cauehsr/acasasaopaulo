  ...
  links: [
    {
      ...
      title: "Marcas Certas",
      description:
        "Encontre produtos das marcas Brastemp, Consul, KitchenAid, Sony e mais.",
    },
    {
      icon: "ds-top-promotions",
      title: "Melhores promoções",
      description:
        "Produtos marca própria direto da fábrica para garantir a melhor opção para o seu bolso.",
    },
    {
      icon: "ds-earn-credits",
      title: "Convide e Ganhe",
      description:
        "Convide seus amigos e ganhe créditos para comprar ainda mais barato.",
    },
    {
      icon: "ds-earn-share",
      title: "Programa de benefícios",
      description:
        "Cumpra missões, suba de nível e acumule vantagens especiais.",
    },
  ],
};
